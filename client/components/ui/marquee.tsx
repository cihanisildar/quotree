...
export default function Marquee({
  ...
  return (
    <div
      {...props}
      className={cn(
        "group relative flex h-full w-full  [--duration:10s] [--gap:12px] [gap:var(--gap)]",
        {
          "flex-col": vertical,
          "flex-row": !vertical,
        },
    ...
    >
      ...
      {applyMask && (
        <div
          className={cn(
            "pointer-events-none absolute inset-0 z-10 h-full w-full from-5% via-transparent via-50%  dark:from-gray-800/50 dark:via-transparent dark:to-gray-800/50",
            {
